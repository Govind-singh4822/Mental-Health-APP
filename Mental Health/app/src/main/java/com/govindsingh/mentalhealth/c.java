...
public class c extends AppCompatActivity implements View.OnClickListener {
    ...
    void finishQuiz(){
        ...
        {
            String passStatus = "";
            passStatus ="Your Results: ADHD Test";

            new AlertDialog.Builder(this)
                    .setTitle(passStatus)
                    .setMessage("Your Score : Little or No Indication of ADD/ADHD")
        ...
        else if(score>=7 || score<=10)
        {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(passStatus)
                    .setMessage("Your Score : Minimal ADD/ADHD")
                    .setPositiveButton("Restart",(dialogInterface, i) -> restartQuiz() )
                    .setCancelable(false)
                    .show();
        }
        else if(score>=6 || score<=4)
        {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(passStatus)
                    .setMessage("Your Score : Mild Indication of ADD/ADHD")
                    .setPositiveButton("Restart",(dialogInterface, i) -> restartQuiz() )
                    .setCancelable(false)
                    .show();
        }
        else
        {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(passStatus)
                    .setMessage("Your Score : Moderate to Severe ADD/ADHD")
                    .setPositiveButton("Restart",(dialogInterface, i) -> restartQuiz() )
                    .setCancelable(false)
                    .show();
        }
