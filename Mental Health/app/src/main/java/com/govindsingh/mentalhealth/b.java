...
public class b extends AppCompatActivity implements View.OnClickListener {
    ...
    void finishQuiz(){
        ...
        {
            String passStatus = "";
            passStatus ="Your Results: Anxiety Test";

            new AlertDialog.Builder(this)
                    .setTitle(passStatus)
                    .setMessage("Your Score : Little or No Indication of Anxiety")
        ...
        else if(score>=7 || score<=10)
        {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(passStatus)
                    .setMessage("Your Score : Minimal Anxiety")
                    .setPositiveButton("Restart",(dialogInterface, i) -> restartQuiz() )
                    .setCancelable(false)
                    .show();
        }
        else if(score>=6 || score<=4)
        {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(passStatus)
                    .setMessage("Your Score : Mild Indication of Anxiety")
                    .setPositiveButton("Restart",(dialogInterface, i) -> restartQuiz() )
                    .setCancelable(false)
                    .show();
        }
        else
        {
            ...
            new AlertDialog.Builder(this)
                    .setTitle(passStatus)
                    .setMessage("Your Score : Moderate to Severe Anxiety")
                    .setPositiveButton("Restart",(dialogInterface, i) -> restartQuiz() )
                    .setCancelable(false)
                    .show();
        }
